<?php
class controller_webcams extends Controller
{
	function __construct()
	{
		if (isBot() === false)
		{
			...
			if ($_COOKIE['city_id'])
			{
				$this->view = new View('web-cams.tpl');
			}
			else
			{
		...
		$this->view->headers['title'] = 'Веб-камеры | Город 24';
		$this->view->data['menu']['webcams'] = 'active';
	...
	{
		$this->view = new View('web-cams-page.tpl');
		$this->view->data['menu']['webcams'] = 'active';
