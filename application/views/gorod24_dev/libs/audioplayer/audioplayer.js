		...
		this.each( function()
		{
			...
			if( isSupport )
			{
				...
				theAudio.addEventListener( 'loadeddata', function()
				{
					...
					volumeAdjuster.find( '.volumeHandler' ).css("left", 'calc(' + theAudio.volume * 100 + '%' + ' - 5px)' );
			...
			{
                if ($(".mini-radio-player").hasClass("mini-player-playing")) {

                    if( thePlayer.hasClass( cssClass.playing ) )
                    {
                        $("#radio-stream")[0].muted=false;
