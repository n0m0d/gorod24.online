...
class Paginator
{
	...
	public function setLinkAttrs($attrs){
    ...
    public function toHtml()
    {
		...
		$linkAttrs = '';
		foreach($this->linkAttrs as $key=>$val){
			$linkAttrs .= $key.'="'.addslashes($val).'"';
		}

        $html = '<ul class="pagination">';
        if ($this->getPrevUrl()) {
            $html .= '<li><a href="' . $this->getPrevUrl() . '" '.$linkAttrs.'>&laquo; '. $this->previousText .'</a></li>';
        }

        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li' . ($page['isCurrent'] ? ' class="active"' : '') . '><a href="' . $page['url'] . '" '.$linkAttrs.'>' . $page['num'] . '</a></li>';
            } else {
        ...
        if ($this->getNextUrl()) {
            $html .= '<li><a href="' . $this->getNextUrl() . '" '.$linkAttrs.'>'. $this->nextText .' &raquo;</a></li>';
        }
        $html .= '</ul>';
