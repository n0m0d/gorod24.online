...
class simple_html_dom
{
    ...
    function load($str, $lowercase=true, $stripRN=true, $defaultBRText=DEFAULT_BR_TEXT, $defaultSpanText=DEFAULT_SPAN_TEXT)
    {
		...
		$this->content = $str;
			...
			$this->_stripRN=$stripRN;
			$this->_defaultBRText=$defaultBRText;
			$this->_defaultSpanText=$defaultSpanText;
        // prepare
        $this->prepare($this->content, $lowercase, $stripRN, $defaultBRText, $defaultSpanText);
        // strip out comments
	...
	function set($Metatext,$text)
	{
		$this->content = str_replace("<!RAW!><!".$Metatext."!><!RAW!>",rawurlencode($text),$this->content);
		$this->content = str_replace("<!".$Metatext."!>",$text,$this->content);
		$this->content = str_replace("<!".strtolower($Metatext)."!>",$text,$this->content);
		$this->content = str_replace('{[!'.$Metatext.'!]}',$text,$this->content);
		$this->load($this->content, $this->_lowercase, $this->stripRN, $this->defaultBRText, $this->defaultSpanText);
	}
	
	function append($Metatext,$text)
	{
		$this->content=str_replace("<!RAW!><!".$Metatext."!><!RAW!>","<!RAW!><!".$Metatext."!><!RAW!>".rawurlencode($text),$this->content);
		$this->content=str_replace("<!".$Metatext."!>","<!".$Metatext."!>".$text,$this->content);
		$this->content=str_replace("<!".strtolower($Metatext)."!>","<!".strtolower($Metatext)."!>".$text,$this->content);
		$this->load($this->content, $this->_lowercase, $this->stripRN, $this->defaultBRText, $this->defaultSpanText);
	}
	
	function prepend($Metatext,$text)
	{
		$this->content=str_replace("<!RAW!><!".$Metatext."!><!RAW!>",rawurlencode($text)."<!RAW!><!".$Metatext."!><!RAW!>",$this->content);
		$this->content=str_replace("<!".$Metatext."!>",$text."<!".$Metatext."!>",$this->content);
		$this->content=str_replace("<!".strtolower($Metatext)."!>",$text."<!".strtolower($Metatext)."!>",$this->content);
		$this->load($this->content, $this->_lowercase, $this->stripRN, $this->defaultBRText, $this->defaultSpanText);
	}
	
	function remove($Metatext)
	{
		$this->content=str_replace("<!RAW!><!".$Metatext."!><!RAW!>","<!RAW!><!".$Metatext."!><!RAW!>",$this->content);
		$this->content=str_replace("<!".$Metatext."!>","<!".$Metatext."!>",$this->content);
		$this->content=str_replace("<!".strtolower($Metatext)."!>","<!".strtolower($Metatext)."!>",$this->content);
		$this->load($this->content, $this->_lowercase, $this->stripRN, $this->defaultBRText, $this->defaultSpanText);
	}
