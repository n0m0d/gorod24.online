...
function apply_filters_ref_array($tag, $args) {
	global $hooks;
	$args = func_get_args();
	return call_user_func_array(array($hooks, "apply_filters_ref_array"), $args);
...
function do_action_ref_array($tag, $args) {
	global $hooks;
	$args = func_get_args();
	return call_user_func_array(array($hooks, "do_action_ref_array"), $args);
}
...
function __call_all_hook($args) {
	global $hooks;
	return $hooks->__call_all_hook($args);
}
