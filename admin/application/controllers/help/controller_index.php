...
class controller_index extends controller
{
	function __construct(){
		...
		$this->view->headers['title'] = 'Помощь в админке и на сайте | Администрирование Полезного радио';
		$this->view->data['main-menu']['Помощь'] = true;
		$this->view->data['main']['header'] = 'Помощь в админке и на сайте';
	...
	function action_index($actions=null){
		$this->view->data['breadcrumbs'] = [ "Помощь в админке и на сайте"=>$GLOBALS['CONFIG']['HTTP_HOST'].'/admin/help/'];
		$this->view->data['header'] = "Помощь в админке и на сайте";
	}
	
	/********** Рубрики **********/
	function action_rubrics($actions=null){
		$this->view->headers['title'] = 'Рубрики | Администрирование Полезного радио';
		$this->view->data['breadcrumbs'] = [ "Помощь в админке и на сайте"=>$GLOBALS['CONFIG']['HTTP_HOST'].'/admin/help/', "Рубрики"=>$GLOBALS['CONFIG']['HTTP_HOST'].'/admin/help/rubrics/'];
