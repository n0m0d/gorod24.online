...
<div id="icon-edit-pages" class="icon32 icon32-posts-page"><br></div><h2>Страницы</h2>
<div id="wrap-main">
	<div>
		<h3>Основные действия над страницами</h3>
		<a href="/admin/pages/?id=new" class="button-controls add">Добавить страницу</a>
		<button id="delete-pages" class="button-controls delete">Удалить отмеченные страницы</button>
	</div>
	<div class="page-view">
	...
	<table class="main-table" >
		...
		echo "
			<tr id='raw_{$p['post_id']}'>
				...
				<td class=\"{$alt}\"><a href=\"/admin/pages/?id={$p['post_id']}\">"._(apply_filters('name-ru', $p['post_name_ru']))."</a></td>
				<td class=\"{$alt}\"><a href=\"/admin/pages/?id={$p['post_parent']}\">{$p['post_parent']}</a></td>
